...
st1.addEventListener("mouseleave", ()=>{
  ...
  st1.innerHTML = '<div class="display-1 py-5"><i class="fa-solid fa-people-roof"></i></div><div class="h1">Cultural Integration </div><p class="mt-auto pt-3"><a href="culturalintegration.html" style="color: white;">Know More..</a></p>';
})
